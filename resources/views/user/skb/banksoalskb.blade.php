...
@section('subjudul','Bank Soal SKB')
@section('content')
<div class="col-md-12">
    ...
    <div class="col-md-3 fv-row mb-10">
        <select class="form-select form-select-solid border border-info filter-ju" data-control="select2" data-placeholder="Pilih Jenis Ujian" name="instansi">
            <option value="">Pilih Jenis Ujian...</option>
            <option>Tryout Akbar</option>
            <option>Tryout Mandiri</option>
            <option>Latihan Soal</option>           
        </select>
    </div>
    <div class="col-md-3 fv-row">
        <select class=" form-select form-select-solid border border-info filter-js" data-control="select2"  data-placeholder="Pilih Jenis Soal">
            <option value="">Pilih Jenis Soal...</option>
            @foreach($materi as $item)
                <option value="{{$item->id_skb}}">{{$item->jenis_skb}}</option>
            @endforeach         
        </select>
    </div>
</div>
<div class="card-body mt-3">
        <div class="col-md-12">
            <table id="table-bankskb" class="table table-hover">
                <thead>
                    <tr>
                        <th></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="text-center mb-13">
                    <!--begin::Title-->
                    <h1 class="mb-3">Buat Paket Soal SKB</h1>
                    <!--end::Title-->
                    <!--begin::Description-->
                    <div class="text-muted fw-bold fs-5 mb-7">Tekan tombol Generate untuk membuat paket soal
                    <strong class="link-primary fw-bolder">SKB</strong></div>
                    <form id="form-buat-paket" class="form" >
						<!-- {{ csrf_field() }} -->
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
									...
									<select class="form-select form-select-solid drdn" id="filter-submateri" data-control="select2" data-placeholder="Pilih Jenis Submateri" name="submateri">
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var api = '{{url('apibankskb')}}'
    var jns = 0
     var table = $('#table-bankskb').DataTable({
      processing: true,
      serverSide: true,
    //   data: {
    //     jenissoal: jenis
    ...
    function generateSoal(){
        ...
        $.ajax({
            url: "{{url('apitoskb')}}?ju="+valju+"&submateri="+valsm, 
            type: "get",
        ...
        processing: true,
        serverSide: true,
        ajax: "{{url('apitoskb')}}?ju="+valju+"&submateri="+valsm,
        data: {
            ju : valju,
            submateri : valsm,
        },
