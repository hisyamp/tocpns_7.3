...
@section('subjudul','Bank Soal PPPK')
@section('content')
<div class="col-md-12 mb-6">
    <div class="col-sm-2 fv-row">
        <a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#modalBuatPaket" id="tblBuatPaket">Buat Paket</a>
    </div>
    ...
    <div class="col-md-3 fv-row">
        <select class="form-select form-select-solid border border-info filter-js" data-control="select2" data-hide-search="true" data-placeholder="Pilih Jenis Soal" name="instansi">
            ...
            <option value="{{$item->id_pppk}}">{{$item->jenis_pppk}}</option>
            @endforeach
        </select>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="text-center mb-13">
                    <!--begin::Title-->
                    <h1 class="mb-3">Buat Paket Soal PPPK</h1>
                    <!--end::Title-->
                    <!--begin::Description-->
                    <div class="text-muted fw-bold fs-5 mb-7">Tekan tombol Generate untuk membuat paket soal
                    <strong class="link-primary fw-bolder">PPPK</strong></div>
                    <form id="form-buat-paket" class="form" >
						<!-- {{ csrf_field() }} -->
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
									...
									<select class="form-select form-select-solid drdn" id="submateri" data-control="select2" data-hide-search="true" data-placeholder="Pilih Jenis Submateri" name="submateri">
                            ...
                            <div class="row g-9 mb-8">
								...
								<label class="d-flex align-items-center fs-6 fw-bold mb-2 mt-2">
									<span class="required">Kompetensi Teknis</span>
									<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Waktu Ujian"></i>
								</label>
									<select class="form-select form-select-solid border border-success drdn tryout" id="waktukteknis" data-control="select2" data-hide-search="true" data-placeholder="Pilih Jumlah Waktu Ujian (Menit)" name="waktukteknis">
										<option value="">Pilih Waktu Ujian... (Menit)</option>
										<option >20</option>
                                        <option >30</option>
										<option >40</option>
                                        <option >50</option>
								...
								<div class="col-md-4 fv-row">
								<label class="d-flex align-items-center fs-6 fw-bold mb-2 mt-2">
									<span class="required">Kemampuan Manajerial</span>
									<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Waktu Ujian"></i>
								</label>
									<select class="form-select form-select-solid border border-success drdn tryout" id="waktukmanagerial" data-control="select2" data-hide-search="true" data-placeholder="Pilih Jumlah Waktu Ujian (Menit)" name="waktukmanagerial">
										<option value="">Pilih Waktu Ujian... (Menit)</option>
										<option >20</option>
                                        <option >30</option>
										<option >40</option>
                                ...
                                <div class="col-md-4 fv-row">
								<label class="d-flex align-items-center fs-6 fw-bold mb-2 mt-2">
									<span class="required">Kompetensi Sosio Kultural</span>
									<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Waktu Ujian"></i>
								</label>
									<select class="form-select form-select-solid border border-success drdn tryout" id="waktuskultural" data-control="select2" data-hide-search="true" data-placeholder="Pilih Jumlah Waktu Ujian (Menit)" name="waktuskultural">
										<option value="">Pilih Waktu Ujian... (Menit)</option>
										<option >20</option>
                                        <option >30</option>
										<option >40</option>
                               ...
                               <div>
                                   <label class="d-flex align-items-center fs-6 fw-bold mb-2 mt-2">
									...
									<select class="form-select form-select-solid border border-success drdn" id="waktuls" data-control="select2" data-hide-search="true" data-placeholder="Pilih Jumlah Waktu Ujian (Menit)" name="waktuls">
...
<div class="modal fade in" id="modalDetailPaket" tabindex="-1" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-dialog mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                <div class="text-center mb-13">
                    <h1 class="mb-3">Detail Paket Soal</h1>
                </div>
                <div class="col-md-12">
...
<script type="text/javascript">
  $(document).ready(function () {
      ...
      columns: [
        ...
        
        {
           "render": function ( data, type, row ) {
             return '<button class="btn btn-primary btn-sm dtlsoal" data-id="'+ row.id_paket_pppk +'"  data-bs-toggle="modal" data-bs-target="#modalDetailPaket">Detail</button>'
           },
           className: 'dt-body-center'
        }
      ]
    ...
    $('body').on('change', '#jenisujian', function() {
        ...
        if($(this).val() == 3){
            console.log("trueee")
            $("#submateri").addClass('border border-success');
            $("#submateri").removeClass('border border-light');
            $("#submateri").attr("disabled", false);

            $("#jumlahsoal").addClass('border border-success');
            $("#jumlahsoal").removeClass('border border-light');
            $("#jumlahsoal").attr("disabled", false);

            $("#waktuls").removeAttr("disabled")
            $("#waktuls").removeClass('border border-light');
            $("#waktuls").addClass('border border-success');

            $(".tryout").attr("disabled",true);
            $("#waktukt,#waktukm,#waktusk").removeClass('border border-success');
            $("#waktukt,#waktukm,#waktusk").addClass('border border-light');

        }else{
            console.log("false")
            // $("#submateri").addClass('border border-light');
            // $("#submateri").removeClass('border border-success');
            // $("#submateri").attr("disabled", true);
            
            $("#jumlahsoal").attr("disabled", true);
            $("#jumlahsoal").removeClass('border border-success');
            $("#jumlahsoal").addClass('border border-light');

            $("#waktuls").attr("disabled",true)
            $("#waktuls").removeClass('border border-success');
            $("#waktuls").addClass('border border-light');
    ...
    function generateSoal(){
        ...
        $.ajax({
            url: "{{url('apitopppk')}}?ju="+valju+"&submateri="+valsm, 
            type: "get",
            dataType: 'json',
            success: function(data) {
                ...
                console.log("jumlah id = "+arr.length)
            },
            error: function(data) { 
                // console.log(data)    
            }
        ...
        serverSide: true,
        dataType: 'json',
        ajax: "{{url('apitopppk')}}?ju="+valju+"&submateri="+valsm,
        data: {
            ju : valju,
            submateri : valsm,
        },
    ...
    $('#tblgenerate').click(function () {        
        ...
        arrayform = {
            "nama": $('#namapaket').val(),
            "waktukteknis": $('#waktukteknis').val(),
            "waktukmanagerial": $('#waktukmanagerial').val(),
            "waktuskultural": $('#waktuskultural').val(),
