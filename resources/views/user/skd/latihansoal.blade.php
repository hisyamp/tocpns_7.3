...
@section('subjudul','Latihan Soal SKD')
@section('content')
                    ...
                    <div class="card card-xxl-stretch mb-5 mb-xl-8 pb-5" style="background-color: #F7D9E3">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex flex-column mb-7">
                                <!--begin::Title-->
                                <a href="#" class="text-dark text-hover-primary fw-bolder fs-3">Soal TKD 1</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Row-->
                            <div class="row g-0">
                                ...
                                <div class="col-6">
                                    <div class="d-flex align-items-center mb-9 ms-2">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-5 text-dark fw-bolder lh-1">60</div>
                                            <div class="fs-7 text-gray-600 fw-bold">Menit</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <div>
                                            ...
                                            <div class="fs-7 text-gray-600 fw-bold">Poin</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                </div>
